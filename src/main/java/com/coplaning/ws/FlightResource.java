...
public class FlightResource {
	...
	public List<FlightContainer> Serach(@PathParam("departure") String departure,@PathParam("arrival") String arrival,@PathParam("seat") int seat,@PathParam("cost") int cost ) {
